            ...
            <div className="max-w-6xl mx-auto px-4 lg:px-0 py-4 flex items-center justify-between">
                <div className="">
                    <a href="" className="dark:text-white flex items-center space-x-2">
                        ...
                        <span className="text-2xl font-bold">Dharmik</span>
                    </a>
                </div>
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <a href="https://github.com/Dharmik0121" className="text-sm font-semibold hover:text-gray-400 transition-all duration-200" target='_blank' rel="noreferrer"><RiGithubFill className='w-6 h-6' /></a>
